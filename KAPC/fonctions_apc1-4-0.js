// === version 1.4.0  2022/12/21 ===
// 1.4.0   prendre en compte projet et alternance dans les traces
...
function specificDisplayPortfolios(type){
	if (USER.other=="enseignant") {
		...
		for (var i=0;i<portfolios_list.length;i++){
			//--------------------------
			if (portfolios_list[i].visible && $(portfolios_list[i].code_node).text().indexOf('portfolio-etu')<0 && $(portfolios_list[i].code_node).text().indexOf('portfolio-pp')<0) {
